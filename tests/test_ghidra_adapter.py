...
def test_parse_function_inventory_identifies_generic_and_jni(tmp_path: Path):
    inventory = tmp_path / "functions.tsv"
    inventory.write_text(
        "001000\tFUN_001000\tfalse\tfalse\t42\n"
        "002000\tJava_com_example_Game_nativeTick\tfalse\tfalse\t128\n"
        "003000\tJNI_OnLoad\tfalse\tfalse\t64\n"
        "004000\tputs\ttrue\ttrue\t0\n",
        encoding="utf-8",
    )

    functions, sample = parse_function_inventory(inventory)
